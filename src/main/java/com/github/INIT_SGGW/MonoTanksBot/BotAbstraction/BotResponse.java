...
/**
 * Abstract class representing a response from a bot.
 */
...
public abstract class BotResponse {
    ...
    @Setter
    @ToString
    public static class Move extends BotResponse {
        /**
    ...
    @Setter
    @ToString
    public static class RotationResponse extends BotResponse {
    ...
    @JsonTypeName("pass")
    @ToString
    public static class ResponsePass extends BotResponse {
        /**
    ...
    @Setter
    @ToString
    public static class AbilityUse extends BotResponse {
        /**
     ...
     */
    public static BotResponse createMoveResponse(MoveDirection direction) {
     ...
     */
    public static BotResponse createRotationResponse(Optional<RotationDirection> tankRotationDirection,
            Optional<RotationDirection> turretRotationDirection) {
     ...
     */
    public static BotResponse createPassResponse() {
        return new ResponsePass();
    }
     ...
     */
    public static BotResponse createAbilityUseResponse(AbilityType abilityType) {
